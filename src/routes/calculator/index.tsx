...
export const Route = createFileRoute("/calculator/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Estimate your daily calorie and protein needs based on your goal.",
      },
    ],
  }),
  component: Calc,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          A simple estimate to set your daily targets.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        ...
        <aside className="space-y-3 rounded-3xl border border-border bg-card p-6 shadow-[var(--shadow-soft)] lg:sticky lg:top-24">
          ...
          <p className="pt-2 text-xs text-muted-foreground">
            Estimates use the Mifflin-St Jeor formula. Adjust based on real-world results after 2–3
            weeks.
          </p>
        </aside>
      </div>
...
function Result({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between rounded-2xl border border-border p-4",
