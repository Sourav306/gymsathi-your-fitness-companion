...
export const EXERCISE_ALTERNATIVES: Record<string, AlternativeSuggestion> = {
  ...
  "pec-deck": {
    homeAlternativeId: "incline-db-press",
    homeAlternativeName: "Incline Dumbbell Press",
  },
  "cable-fly": {
    homeAlternativeId: "incline-db-press",
    homeAlternativeName: "Incline Dumbbell Press",
  ...
  "incline-db-press": {
    gymAlternativeId: "machine-chest-press",
    gymAlternativeName: "Machine Chest Press",
  },

  // Back — gym → home
  "lat-pulldown": {
    homeAlternativeId: "assisted-pullup",
    homeAlternativeName: "Band/Assisted Pull-Up",
  },
  "seated-row": { homeAlternativeId: "db-row", homeAlternativeName: "One-Arm Dumbbell Row" },
  "straight-arm-pulldown": {
    homeAlternativeId: "db-row",
    homeAlternativeName: "One-Arm Dumbbell Row",
  },
  ...
  "leg-extension": {
    homeAlternativeId: "lunges",
    homeAlternativeName: "Walking Lunges / Step-Ups",
  },
  ...
  // Shoulders
  ohp: {
    homeAlternativeId: "shoulder-press-machine",
    homeAlternativeName: "Dumbbell Shoulder Press",
  },
  "shoulder-press-machine": {
    homeAlternativeId: "lateral-raise",
    homeAlternativeName: "Dumbbell Lateral Raise",
  },

  // Arms
  "tricep-pushdown": {
    homeAlternativeId: "overhead-tricep",
    homeAlternativeName: "DB Overhead Tricep Extension",
  },
  ...
  "overhead-tricep": {
    gymAlternativeId: "tricep-pushdown",
    gymAlternativeName: "Tricep Rope Pushdown",
  },
